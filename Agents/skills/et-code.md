...
5. 涉及 `async` / `await` / `ETTask` / `EntityRef` 时，叠加 `Agents/skills/et-async.md`。
...
- 文件、`.meta`、包落点、包层级：补读 `Agents/skills/references/et-code-rules.md`
- ECS 数据/逻辑边界、组件契约、Module analyzer：补读 `Agents/skills/references/et-code-rules.md`
