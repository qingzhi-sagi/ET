...
namespace ET
{
    ...
    // 同步任务数据请求
    [MemoryPackable]
    [Message(WOWOuter.C2M_SyncQuestData)]
    ...
    [MemoryPackable]
    [Message(WOWOuter.M2C_SyncQuestData)]
    ...
    // 放弃任务
    [MemoryPackable]
    [Message(WOWOuter.C2M_AbandonQuest)]
    ...
    [MemoryPackable]
    [Message(WOWOuter.M2C_AbandonQuest)]
    ...
    // 查询可接取任务
    [MemoryPackable]
    [Message(WOWOuter.C2M_QueryAvailableQuests)]
    ...
    [MemoryPackable]
    [Message(WOWOuter.AvailableQuestInfo)]
    ...
    [MemoryPackable]
    [Message(WOWOuter.M2C_QueryAvailableQuests)]
    ...
    // 任务完成通知
    [MemoryPackable]
    [Message(WOWOuter.M2C_QuestComplete)]
    ...
    // 任务失败通知
    [MemoryPackable]
    [Message(WOWOuter.M2C_QuestFailed)]
    ...
    // 任务进度提示
    [MemoryPackable]
    [Message(WOWOuter.M2C_QuestProgress)]
    ...
    // 获取任务详情
    [MemoryPackable]
    [Message(WOWOuter.C2M_GetQuestDetail)]
    ...
    [MemoryPackable]
    [Message(WOWOuter.QuestDetailInfo)]
    ...
    [MemoryPackable]
    [Message(WOWOuter.M2C_GetQuestDetail)]
