...
namespace ET
{
    ...
    [MemoryPackable]
    [Message(Opcode.Match2Map_GetRoom)]
    ...
    [MemoryPackable]
    [Message(Opcode.Map2Match_GetRoom)]
    ...
    [MemoryPackable]
    [Message(Opcode.G2Room_Reconnect)]
    ...
    [MemoryPackable]
    [Message(Opcode.Room2G_Reconnect)]
    ...
    [MemoryPackable]
    [Message(Opcode.RoomManager2Room_Init)]
    ...
    [MemoryPackable]
    [Message(Opcode.Room2RoomManager_Init)]
