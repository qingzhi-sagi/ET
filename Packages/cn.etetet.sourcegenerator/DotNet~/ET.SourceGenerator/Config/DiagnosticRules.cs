...
namespace ET
{
    ...
    public static class ETTaskInSyncMethodAnalyzerRule
    {
        ...
        private const string MessageFormat = "方法: {0} 在非异步方法体内使用时需要添加.NoContext()后缀,或者WithContext";
    ...
    public static class ETTaskInAsyncMethodAnalyzerRule
    {
        ...
        private const string MessageFormat = "方法: {0} 在异步方法体内使用时需要添加await前缀 或.NoContext()后缀,或WithContext";
