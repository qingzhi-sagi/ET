namespace ET.Server
{
    public static class AddressHelper
    {
        ...
        {
            addressSingleton.InnerIP ??= startProcessConfig.InnerIP;
            addressSingleton.OuterIP ??= startProcessConfig.OuterIP;
        ...
        public static int GetSceneOuterPort(this AddressSingleton addressSingleton, string sceneName)
        {
