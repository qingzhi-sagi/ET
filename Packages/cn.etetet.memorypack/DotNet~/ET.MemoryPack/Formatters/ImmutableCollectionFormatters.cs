...
namespace MemoryPack.Formatters
{
    ...
    {
        [Preserve]
        public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref ImmutableArray<T?> value)
        {
            if (value.IsDefault)
            {
        ...
        [Preserve]
        public override void Deserialize(ref MemoryPackReader reader, ref ImmutableArray<T?> value)
        {
    ...
    {
        [Preserve]
        public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref ImmutableList<T?>? value)
        {
            if (value == null)
            {
                writer.WriteNullCollectionHeader();
        ...
        [Preserve]
        public override void Deserialize(ref MemoryPackReader reader, ref ImmutableList<T?>? value)
        {
    ...
    {
        [Preserve]
        public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref ImmutableQueue<T?>? value)
        {
            if (value == null)
            {
                writer.WriteNullCollectionHeader();
        ...
        [Preserve]
        public override void Deserialize(ref MemoryPackReader reader, ref ImmutableQueue<T?>? value)
        {
            if (!reader.TryReadCollectionHeader(out var length))
            {
                value = null;
    ...
    {
        [Preserve]
        public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref ImmutableStack<T?>? value)
        {
            if (value == null)
            {
                writer.WriteNullCollectionHeader();
        ...
        [Preserve]
        public override void Deserialize(ref MemoryPackReader reader, ref ImmutableStack<T?>? value)
        {
            if (!reader.TryReadCollectionHeader(out var length))
            {
                value = null;
        ...
        where TKey : notnull
    {
        ...
        [Preserve]
        public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref ImmutableDictionary<TKey, TValue?>? value)
        {
            if (value == null)
            {
                writer.WriteNullCollectionHeader();
        ...
        [Preserve]
        public override void Deserialize(ref MemoryPackReader reader, ref ImmutableDictionary<TKey, TValue?>? value)
        {
            if (!reader.TryReadCollectionHeader(out var length))
            {
                value = null;
    ...
    public sealed class ImmutableHashSetFormatter<T> : MemoryPackFormatter<ImmutableHashSet<T?>>
    {
        ...
        [Preserve]
        public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref ImmutableHashSet<T?>? value)
        {
            if (value == null)
            {
                writer.WriteNullCollectionHeader();
        ...
        [Preserve]
        public override void Deserialize(ref MemoryPackReader reader, ref ImmutableHashSet<T?>? value)
        {
            if (!reader.TryReadCollectionHeader(out var length))
            {
                value = null;
        ...
        where TKey : notnull
    {
        ...
        [Preserve]
        public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref ImmutableSortedDictionary<TKey, TValue?>? value)
        {
            if (value == null)
            {
                writer.WriteNullCollectionHeader();
        ...
        [Preserve]
        public override void Deserialize(ref MemoryPackReader reader, ref ImmutableSortedDictionary<TKey, TValue?>? value)
        {
            if (!reader.TryReadCollectionHeader(out var length))
            {
                value = null;
    ...
    public sealed class ImmutableSortedSetFormatter<T> : MemoryPackFormatter<ImmutableSortedSet<T?>>
    {
        ...
        [Preserve]
        public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref ImmutableSortedSet<T?>? value)
        {
            if (value == null)
            {
                writer.WriteNullCollectionHeader();
        ...
        [Preserve]
        public override void Deserialize(ref MemoryPackReader reader, ref ImmutableSortedSet<T?>? value)
        {
            if (!reader.TryReadCollectionHeader(out var length))
            {
                value = null;
    ...
    {
        [Preserve]
        public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref IImmutableList<T?>? value)
        {
            if (value == null)
            {
                writer.WriteNullCollectionHeader();
        ...
        [Preserve]
        public override void Deserialize(ref MemoryPackReader reader, ref IImmutableList<T?>? value)
        {
            if (!reader.TryReadCollectionHeader(out var length))
            {
                value = null;
    ...
    {
        [Preserve]
        public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref IImmutableQueue<T?>? value)
        {
            if (value == null)
            {
                writer.WriteNullCollectionHeader();
        ...
        [Preserve]
        public override void Deserialize(ref MemoryPackReader reader, ref IImmutableQueue<T?>? value)
        {
            if (!reader.TryReadCollectionHeader(out var length))
            {
                value = null;
    ...
    {
        [Preserve]
        public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref IImmutableStack<T?>? value)
        {
            if (value == null)
            {
                writer.WriteNullCollectionHeader();
        ...
        [Preserve]
        public override void Deserialize(ref MemoryPackReader reader, ref IImmutableStack<T?>? value)
        {
            if (!reader.TryReadCollectionHeader(out var length))
            {
                value = null;
        ...
        where TKey : notnull
    {
        ...
        [Preserve]
        public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref IImmutableDictionary<TKey, TValue?>? value)
        {
            if (value == null)
            {
                writer.WriteNullCollectionHeader();
        ...
        [Preserve]
        public override void Deserialize(ref MemoryPackReader reader, ref IImmutableDictionary<TKey, TValue?>? value)
        {
            if (!reader.TryReadCollectionHeader(out var length))
            {
                value = null;
    ...
    public sealed class InterfaceImmutableSetFormatter<T> : MemoryPackFormatter<IImmutableSet<T?>>
    {
        ...
        [Preserve]
        public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref IImmutableSet<T?>? value)
        {
            if (value == null)
            {
                writer.WriteNullCollectionHeader();
        ...
        [Preserve]
        public override void Deserialize(ref MemoryPackReader reader, ref IImmutableSet<T?>? value)
        {
            if (!reader.TryReadCollectionHeader(out var length))
            {
                value = null;
