...
namespace MemoryPack.Formatters
{
        ...
        where TKey : notnull
    {
        ...
        [Preserve]
        public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref FrozenDictionary<TKey, TValue?>? value)
        {
            if (value == null)
            {
        ...
        [Preserve]
        public override void Deserialize(ref MemoryPackReader reader, ref FrozenDictionary<TKey, TValue?>? value)
        {
    ...
    public sealed class FrozenSetFormatter<T> : MemoryPackFormatter<FrozenSet<T?>>
    {
        ...
        [Preserve]
        public override void Serialize<TBufferWriter>(ref MemoryPackWriter<TBufferWriter> writer, ref FrozenSet<T?>? value)
        {
            if (value == null)
            {
                writer.WriteNullCollectionHeader();
        ...
        [Preserve]
        public override void Deserialize(ref MemoryPackReader reader, ref FrozenSet<T?>? value)
        {
            if (!reader.TryReadCollectionHeader(out var length))
            {
                value = null;
