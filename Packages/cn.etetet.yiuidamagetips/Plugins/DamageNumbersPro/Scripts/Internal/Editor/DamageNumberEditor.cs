        ...
        void DisplayFeature(string togglePropertyName, string featureTitle = "", string displayedTitle = "")
        {
            ...
            if(showHints)
            {
                ...
                switch(featureTitle)
                {
                    ...
                    //Performance:
                    case ("Pooling"):
                        DNPEditorInternal.Label("< b >功能:< / b >");
                        DNPEditorInternal.Label("-通过循环伤害数提高<b>刷出性能</b>");
                        DNPEditorInternal.Label("");
                        DNPEditorInternal.Label("<b>信息：</b>");
                        DNPEditorInternal.Label("-如果你每秒产生更多的伤害，池大小应该<b>更高</b>");
                        DNPEditorInternal.Label("如果还没满，新的伤害值会被添加到</b>");
                        DNPEditorInternal.Label("-每个预制件都有自己的<b>池。");
                        DNPEditorInternal.Label("-在预制上使用<b>PrewarmPool()</b>来准备它的池。");
                        break;
                }
