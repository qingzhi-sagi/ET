...
8. 编译luban，用rider打开Packages/cn.etetet.yiuiluban/DontNet~/luban/src/Luban.sln, 编译完成之后才能导出Excel配置
...
13. 执行Unity菜单ET->Init->CodeMode,这里会刷新unity的asmdef reference, 如果unity中找不到这个菜单，可以用命令行dotnet ./Bin/ET.CodeMode.dll
