...
2. Unity中按下F6编译，注意，不能用IDE编译Model Hotfix，因为IDE编译的里面会引用UnityEditor，会导致出问题
...
6. ET.YooAssets/Resources YooConfig中 EPlayMode选择'HostPlayMode', 打开File->Build Profiles->点击Build，选择目录为Release
